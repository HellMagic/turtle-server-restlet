...
public class Connection<T extends Connector> implements SelectionListener {
    ...
    /**
     * Indicates if at least one way is in the {@link org.restlet.engine.io.IoState#READY} state.
     * 
     * @return True if at least one way is in the {@link org.restlet.engine.io.IoState#READY} state.
     */
